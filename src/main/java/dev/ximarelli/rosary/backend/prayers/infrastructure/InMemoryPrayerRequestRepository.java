package dev.ximarelli.rosary.backend.prayers.infrastructure;

import dev.ximarelli.rosary.backend.prayers.domain.PrayerRequest;
import dev.ximarelli.rosary.backend.prayers.domain.PrayerRequestRepository;
