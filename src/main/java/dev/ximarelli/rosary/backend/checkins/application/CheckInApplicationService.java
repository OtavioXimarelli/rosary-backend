...
import dev.ximarelli.rosary.backend.checkins.domain.CheckIn;
import dev.ximarelli.rosary.backend.checkins.domain.CheckInComment;
import dev.ximarelli.rosary.backend.checkins.domain.CheckInRepository;
