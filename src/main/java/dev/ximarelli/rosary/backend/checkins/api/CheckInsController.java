...
import dev.ximarelli.rosary.backend.checkins.application.CheckInApplicationService;
import dev.ximarelli.rosary.backend.checkins.application.CheckInView;
import dev.ximarelli.rosary.backend.checkins.application.UserCheckInStats;
